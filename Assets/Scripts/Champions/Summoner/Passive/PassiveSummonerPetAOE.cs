...
public class PassiveSummonerPetAOE : PassiveBase {
    ...
    void Update()
    {
        float dist = Vector3.Distance(GetComponentInChildren<AllyMonster>().transform.position, transform.position); // process the distance between the SummonerAOE and his Pet
